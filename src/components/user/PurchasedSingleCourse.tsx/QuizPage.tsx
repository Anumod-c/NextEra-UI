          ...
          <div className="w-full max-w-3xl bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-6 space-y-4">
              {currentQuiz.options.map((option, index) => (
                <button
                  key={index}
                  className={`block w-full text-left px-4 py-3 rounded-lg border-2 transition ${userAnswers[currentQuestionIndex] === index
              ...
              if (scorePercentage === 100) {
                ...
                return (
                  <>
                    <Player
                      autoplay
                      loop
                      src="https://lottie.host/15ad7e90-e0e0-42eb-8695-9aa9865d128b/97JVYhyDPg.json" style={{ height: "400px", width: "400px" }} 
                    />
                ...
                return (
                  <>
                    <Player
                      autoplay
                      loop
                      src="https://lottie.host/91cfc469-9348-41c2-8cfe-a861335ea876/BrnoIQsPUa.json" style={{ height: "400px", width: "400px" }} 
                    />
                ...
                return (
                  <>
                    <Player
                      autoplay
                      loop
                      src="https://lottie.host/f0a86cf9-8276-4831-84ef-21a2d78e17a8/vDVqtnuw9k.json" style={{ height: "400px", width: "400px" }} 
                    />
                ...
                return (<>
                  <Player
                    autoplay
                    loop
                    src="https://lottie.host/7c95a873-d087-4529-a6fa-5ec294a7570d/j0pxjmrnj3.json" style={{ height: "400px", width: "400px" }} 
                  />
