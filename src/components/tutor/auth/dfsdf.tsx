...
const TutorAdditionalInfo = () => {
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      if (fieldName === 'profilePicture') setPreviewImage(null);
    }
  };
            ...
            <Form className="space-y-6">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <input
                  ...
                  className="hidden"
                  accept="image/*"
                  onChange={(e) => handleImageUpload(e, setFieldValue, 'profilePicture')}
                />
                <ErrorMessage
                  name="profilePicture"
                  component="div"
                  ...
                  {values.qualifications.map((_, index) => (
                    <div key={index} className="space-y-2 mb-4">
                      <Field
                        ...
                        className="w-full h-10 p-2 shadow-lg rounded-lg"
                      ...
                      {values.qualifications.length > 1 && (
                        <button
                          type="button"
                          onClick={() => {
                            const newQualifications = values.qualifications.filter((_, i) => i !== index);
              ...
              <div className='flex flex-col items-center'>
                ...
                <input
                  ...
                  onChange={(e) => handleImageUpload(e, setFieldValue, 'cv')}
                />
                <ErrorMessage
                  name="cv"
                  component="div"
              ...
              <button
                ...
                className="w-full bg-blue-500 text-white py-2 rounded-lg shadow-lg hover:bg-blue-600"
              >
